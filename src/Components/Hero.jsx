...
const HeroSection = () => {
  return (
    <section className="relative h-[585px] w-full max-w-[1440px] mx-auto bg-cover bg-center">
      <img
      ...
      >
        ...
        >
          ...
          <p className="text-sm text-left mt-auto font-[500] text-gray-400">
            ...
            <span className="text-gray-600"> registrations, tax fillings,</span>
            and other
        ...
        <div className="h-1/5 w-[474px] ml-[70px] space-x-4">
          ...
          <button>
            <IoPlayCircleSharp size={22} className="inline text-red-600 mr-1" />
            See how it works
          </button>
        </div>
      </div>
